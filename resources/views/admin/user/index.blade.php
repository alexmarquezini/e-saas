<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <Link type="button" href="/user/create" modal
            ...
            <x-splade-table :for="$users" striped>
                @cell('action', $user)
                    <!-- Edit Button -->
                    <Link modal href="/user/{{ $user->id }}/edit" type="button"
                    ...
                    <!-- Show Button -->
                    <Link slideover href="/user/{{ $user->id }}" type="button"
                    ...
                    <!-- Delete Button -->
                    <Link href="{{ route('user.destroy', $user) }}" method="DELETE"type="button"
                        ...
                        confirm="Tem certeza que quer excluir {{ $user->name }}?"
                        confirm-text="Essa ação não poderá ser desfeita!" confirm-button="Sim, exclua!"
                        confirm-button-color="red" cancel-button="Não, nem pensar!">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-4 h-4">
                        <path stroke-linecap="round" stroke-linejoin="round"
